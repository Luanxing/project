...
export default {
  ...
  mounted() {
    axios
      .get(
        "/Service/callback.mi/PageSubArea/GetRecommendationIndexInfo.api?t=201961312165819626"
      )
      .then(res => {
      ...
      axios
        .get(
          "/Service/callback.mi/PageSubArea/TrailerList.api?t=201961312165981201"
        )
        .then(res => {
...
.a0 {
  ...
  .i_video {
    ...
    background: url(https://static1.mtime.cn/html5/20190531185056/images/2014/viceoplay.png)
